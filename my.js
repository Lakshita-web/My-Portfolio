...
mode.addEventListener("click",()=>{
    if (currentmode==="light") {
        ...
        document.querySelector("#options").style.backgroundColor = "#291600"; 
         document.querySelector("section").style.backgroundImage= "url('https://i.ibb.co/K1mDyY9/bg.png')"; 
             ...
             document.querySelector("#mode").style.backgroundImage = "url('https://i.ibb.co/m5c1VFXX/lightmode.png')";
               document.querySelector("#picture2").style.backgroundImage = "url('https://i.ibb.co/jSjm06Y/image.png')";
        ...
        currentmode="light";
        document.querySelector("section").style.backgroundImage = "url('https://i.ibb.co/DPTdn0Qw/dark.jpg')"; 
        document.querySelector("section").style.backgroundSize = "cover";
        ...
        document.querySelector("#options").style.backgroundColor = "#180241";   
         ...
         document.querySelector("#mode").style.backgroundImage = "url('https://i.ibb.co/27x0GfKv/darkmode.png')";
